...
class ServiceProviderProfile(models.Model):
    ...
    media = models.FileField(upload_to=f'profile_pictures/{first_name}{last_name}/',null=True, blank=True, verbose_name='image')
...
class Profile(models.Model):
    ...
    profile_picture=models.ImageField(upload_to=f'profile_pictures/{username}/',blank=True,null=True)
